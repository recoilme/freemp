 ...
 * <p>
 * Usage: <br>
 * * Create a new instance of this class providing the {@link android.widget.BaseAdapter} to wrap, the undo layout, the undo button id and a {@link com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoAdapter.DeleteItemCallback}, optionally a delay time millis,
...
public class ContextualUndoAdapter extends BaseAdapterDecorator implements ContextualUndoListViewTouchListener.Callback {
     ...
     * @param deleteItemCallback The {@link com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoAdapter.DeleteItemCallback} which is called when an item should be deleted from your collection.
     */
     ...
     * @param deleteItemCallback The {@link com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoAdapter.DeleteItemCallback} which is called when an item should be deleted from your collection.
     * @param countDownFormatter The {@link com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoAdapter.CountDownFormatter} which provides text to be shown in the {@link android.widget.TextView} as specified by countDownTextViewResId
     */
     ...
     * @param outState the {@link android.os.Bundle} provided by Activity.onSaveInstanceState(Bundle).
     */
    ...
    /**
     * Cancels the count down, and removes any item that was swiped away, without animating. Will cause {@link com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoAdapter.DeleteItemCallback#deleteItem(int)} to be called.
     */
    ...
    /**
     * Removes any item that was swiped away, animating the removal (collapsing the item). {@link com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoAdapter.DeleteItemCallback#deleteItem(int)} to be called.
     */
    ...
    /**
     * Cancel the count down. This will not cause the {@link com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoAdapter.DeleteItemCallback#deleteItem(int)} to be called. Use {@link #removePendingItem()} for that instead.
     */
