...
public class AdapterViewUtil {
     ...
     * Unlike {@link android.widget.AdapterView#getPositionForView(android.view.View)}, returned position will reflect the position of the item given view is representing,
     ...
     * @return the position of the item in the AdapterView represented by given view, or {@link android.widget.AdapterView#INVALID_POSITION} if the view does not
