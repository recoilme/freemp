...
/**
 * An EXPERIMENTAL adapter for inserting rows into the {@link android.widget.ListView} with an animation. The root {@link android.widget.BaseAdapter} should implement {@link com.nhaarman.listviewanimations.itemmanipulation.AnimateAdditionAdapter.Insertable},
...
public class AnimateAdditionAdapter<T> extends BaseAdapterDecorator {
     ...
     * Will also call {@link com.nhaarman.listviewanimations.itemmanipulation.AnimateAdditionAdapter.Insertable#add(int, Object)} of the root {@link android.widget.BaseAdapter}.
     *
