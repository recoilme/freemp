 ...
 * Also implements {@link com.nhaarman.listviewanimations.widget.DynamicListView.Swappable} for easy object swapping, and {@link com.nhaarman.listviewanimations.itemmanipulation.AnimateAdditionAdapter.Insertable} for inserting objects.
 */
...
public abstract class ArrayAdapter<T> extends BaseAdapter implements List<T>, DynamicListView.Swappable, AnimateAdditionAdapter.Insertable<T> {
    ...
    /**
     * Creates a new {@link com.nhaarman.listviewanimations.ArrayAdapter} using given {@code List} , or an empty {@code List}  if objects == null.
     */
    ...
    /**
     * Creates a new {@link com.nhaarman.listviewanimations.ArrayAdapter}, using (a copy of) given {@code List} , or an empty {@code List}  if objects = null.
