...
public class DlgChooseDirectory implements AdapterView.OnItemClickListener, DialogInterface.OnClickListener
{
    ...
    public class DirAdapter extends ArrayAdapter< File >
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            {
                textview.setText( ".." );
                textview.setCompoundDrawablesWithIntrinsicBounds( m_context.getResources().getDrawable( R.drawable.icon ), null, null, null );
            }
            else
            {
    ...
    public DlgChooseDirectory(Context ctx, Result res, String startDir)
    {
        ...
        View view = ((Activity)ctx).getLayoutInflater().inflate(R.layout.dialog_dirlist, null);
